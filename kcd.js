...
function getBalancedMDSequence(imbalancedMD, birthData, dob) {
    ...
    console.log("balanced Years : " + balanceAtBirthInYears)
    ...
    console.log("dasha Data : " + adjustedDashaData)
...
function getDirectionArray(extrapolatedDasha) {
    ...
    console.log("dir1 : ", directionArray1)
    ...
    for (; i < directionArray1.length - 2; i++) {
        ...
        if (Math.abs(directionArray1[i]) >= 4)
            direction = directionArray1[i + 1] > 0 ? 1 : -1;
        directionArray2[i] = direction;
    }
    console.log("dir2 : ", directionArray2)
